...
import type { IList, ITask } from '../../store/types';
import { useTypedDispatch } from '../../hooks/redux';
import { deleteList, setModalActive } from '../../store/slices/boardsSlice';
import { addLog } from '../../store/slices/loggerSlice';
import { v4 } from 'uuid';
import { setModalDate } from '../../store/slices/modalSlice';
import { deleteButton, name, header, listWrapper } from './List.css';
...
const List: FC<TListProps> = ({ boardId, list }) => {
  ...
  const handleTaskChange = (
    ...
    dispatch(setModalDate({ boardId, listId, task }));
